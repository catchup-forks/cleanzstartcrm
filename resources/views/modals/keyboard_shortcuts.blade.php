  ...
  <div class="modal-dialog">
    <div class="modal-content">
          ...
          <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="keyboard_shortcuts">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3 key-label">{{ trans('texts.new_customer') }}</div>
                  </div>
                  <div class="row">
                      <div class="col-md-3"><div>/</div></div>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3 key-label">{{ trans('texts.list_customers') }}</div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                      ...
                      <p>
                          <ul>
                              ...
                              <li>Find &lt;customer name&gt;</li>
                              <li>Show me &lt;customer name&gt;'s past due invoices</li>
                              <li>New invoice for &lt;customer name&gt;</li>
                              <li>Create payment for invoice &lt;invoice number&gt;</li>
                          </ul>
                      </p>
                      <p>
                          {!! trans('texts.voice_commands_feedback', ['email' => Html::mailto('contact@gmail.com')]) !!}
                      </p>
                  </div>
              </div>
          </div>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="#" target="_blank">{{ trans('texts.knowledge_base') }}</a>
        <a class="btn btn-primary" href="#" target="_blank">{{ trans('texts.user_guide') }}</a>
        <a class="btn btn-primary" href="#" target="_blank">YouTube {{ trans('texts.videos') }}</a>
      </div>
    </div>
  </div>
</div>
        ...
        */
        ...
        @foreach([
            ...
            Mousetrap.bind('n {{ $key }}', function(e) {
                ...
                @if (in_array($value, [ENTITY_INVOICE, ENTITY_PAYMENT, ENTITY_TICKET, ENTITY_VENDOR, ENTITY_RECURRING_INVOICE]))
                    if (location.pathname.indexOf('/customers/') >= 0) {
