...
if (! defined('APP_NAME')) {
    define('APP_NAME', env('APP_NAME', 'CleanCrm'));
    define('APP_DOMAIN', env('APP_DOMAIN', 'cleancrm.com'));
    ...
    define('ENTITY_COMPANY_GATEWAY', 'company_gateway');
    ...
    define('ENTITY_BANK_COMPANY', 'bank_company');
    define('ENTITY_BANK_SUBCOMPANY', 'bank_subcompany');
    ...
    define('ENTITY_TICKET_THREAD', 'ticket_thread');
    define('ENTITY_TICKET_STATUS', 'ticket_status');
    define('ENTITY_TICKET_CATEGORY', 'ticket_category');
    define('ENTITY_TICKET_PRIORITY', 'ticket_priority');
    ...
    define('INVOICE_ITEM_TYPE_TICKET', 2);
    ...
    define('COMPANY_PLAN_DETAILS', 'company_details');
    define('COMPANY_STAFF_DETAILS', 'staff_details');
    ...
    define('COMPANY_MANAGEMENT', 'company_management');
    define('COMPANY_PAYMENTS', 'online_payments');
    define('COMPANY_BANKS', 'company_banks');
    ...
    define('COMPANY_TICKETS', 'tickets');
    ...
    define('COMPANY_CUSTOMER_PORTAL', 'customer_portal');
    ...
    define('TIMELINE_TYPE_CREATE_CUSTOMER', 1);
    define('TIMELINE_TYPE_ARCHIVE_CUSTOMER', 2);
    define('TIMELINE_TYPE_DELETE_CUSTOMER', 3);
    ...
    define('TIMELINE_TYPE_RESTORE_CUSTOMER', 26);
    ...
    define('TIMELINE_TYPE_CREATE_TICKET', 42);
    define('TIMELINE_TYPE_UPDATE_TICKET', 43);
    define('TIMELINE_TYPE_ARCHIVE_TICKET', 44);
    define('TIMELINE_TYPE_DELETE_TICKET', 45);
    define('TIMELINE_TYPE_RESTORE_TICKET', 46);
    ...
    define('MAX_NUM_CUSTOMERS_PRO', 20000);
    define('MAX_NUM_CUSTOMERS_LEGACY', 500);
    ...
    define('TICKET_STATUS_LOGGED', -1);
    define('TICKET_STATUS_RUNNING', -2);
    define('TICKET_STATUS_INVOICED', -3);
    define('TICKET_STATUS_PAID', -4);
    ...
    define('SESSION_USER_COMPANIES', 'userAccounts');
    ...
    define('EVENT_CREATE_CUSTOMER', 1);
    ...
    define('EVENT_UPDATE_CUSTOMER', 10);
    define('EVENT_DELETE_CUSTOMER', 11);
    ...
    define('EVENT_CREATE_TICKET', 18);
    define('EVENT_UPDATE_TICKET', 19);
    define('EVENT_DELETE_TICKET', 20);
    define('EVENT_APPROVE_QUOTE', 21);

    define('REQUESTED_PRO_PLAN', 'REQUESTED_PRO_PLAN');
    define('CLEANCRM_COMPANY_KEY', env('CLEANCRM_COMPANY_KEY', 'zg4ylmzDkdkPOT8yoKQw9LTWaoZJx79h'));
    define('CLEANCRM_COMPANY_EMAIL', env('CLEANCRM_COMPANY_EMAIL', 'contact@cleancrm.com'));
    define('CLEANCRM_LICENSE_COMPANY_KEY', 'AsFmBAeLXF0IKf7tmi0eiyZfmWW9hxMT');
    define('CLEANCRM_GATEWAY_ID', GATEWAY_STRIPE);
    define('CLEANCRM_GATEWAY_CONFIG', 'CLEANCRM_GATEWAY_CONFIG');
    define('CLEANCRM_WEB_URL', env('CLEANCRM_WEB_URL', 'https://www.cleancrm.com'));
    define('CLEANCRM_APP_URL', env('CLEANCRM_APP_URL', 'https://app.cleancrm.com'));
    define('CLEANCRM_DOCS_URL', env('CLEANCRM_DOCS_URL', 'https://invoice-ninja.readthedocs.io/en/latest'));
    define('CLEANCRM_DATE', '2000-01-01');
    define('CLEANCRM_VERSION', '4.5.5' . env('CLEANCRM_VERSION_SUFFIX'));

    define('CLEANCRM_TERMS_VERSION', '1.0.1');

    define('SOCIAL_LINK_FACEBOOK', env('SOCIAL_LINK_FACEBOOK', 'https://www.facebook.com/cleancrm'));
    define('SOCIAL_LINK_TWITTER', env('SOCIAL_LINK_TWITTER', 'https://twitter.com/cleancrm'));
    define('SOCIAL_LINK_GITHUB', env('SOCIAL_LINK_GITHUB', 'https://github.com/cleancrm/cleancrm/'));

    define('CLEANCRM_FORUM_URL', env('CLEANCRM_FORUM_URL', 'https://www.cleancrm.com/forums/forum/support/'));
    define('CLEANCRM_CONTACT_URL', env('CLEANCRM_CONTACT_URL', 'https://www.cleancrm.com/contact/'));
    define('CLEANCRM_FROM_EMAIL', env('CLEANCRM_FROM_EMAIL', 'maildelivery@cleancrm.com'));
    define('CLEANCRM_IOS_APP_URL', 'https://itunes.apple.com/WebObjects/MZStore.woa/wa/viewSoftware?id=1220337560&mt=8');
    define('CLEANCRM_ANDROID_APP_URL', 'https://play.google.com/store/apps/details?id=com.cleancrm.cleancrm');
    ...
    define('REFERRAL_PROGRAM_URL', env('REFERRAL_PROGRAM_URL', 'https://www.cleancrm.com/referral-program/'));
    ...
    define('DB_CLEANCRM_LOOKUP', 'db-ninja-0');
    define('DB_CLEANCRM_1', 'db-ninja-1');
    define('DB_CLEANCRM_2', 'db-ninja-2');
    ...
    define('RESELLER_COMPANY_COUNT', 'B');
    ...
    define('FEATURE_MORE_CUSTOMERS', 'more_customers');
    ...
    define('WEPAY_CUSTOMER_ID', env('WEPAY_CUSTOMER_ID'));
    define('WEPAY_CUSTOMER_SECRET', env('WEPAY_CUSTOMER_SECRET'));
    ...
    define('INVOICE_FIELDS_CUSTOMER', 'customer_fields');
    ...
    define('INVOICE_FIELDS_TICKET', 'ticket_fields');
    ...
    define('TICKET_PRIORITY_EMERGENCY', 40);

    define('TICKET_STATUS_NEW', 1);
    define('TICKET_STATUS_OPEN',2);
    define('TICKET_STATUS_CLOSED',3);
    define('TICKET_STATUS_MERGED',4);
    define('TICKET_STATUS_ARCHIVED',5);



    define('TICKET_CUSTOMER_NEW', 'ticket_customer_new');
    define('TICKET_CUSTOMER_UPDATE', 'ticket_customer_update');
